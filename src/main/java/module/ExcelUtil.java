...
//向Excel表中填写数据
    public static void setCellData(int RowNum, int ColNum, String SheetName,String value) throws Exception {
        ExcelWSheet = ExcelWBook.getSheet(SheetName);
        try {
            XSSFRow row = ExcelWSheet.createRow(0);
            XSSFCell cell = row.createCell(0);
            cell.setCellValue(value);
            FileOutputStream fos  = new FileOutputStream(new File("C:\\Users\\Mars\\Desktop\\TestFile.xlsx"));
